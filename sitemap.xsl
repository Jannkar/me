	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
			<head>
				...
				<xsl:variable name="tableMinWidth" select="'727'"/><xsl:variable name="colorMain" select="'#222222'"/><xsl:variable name="colorAccent" select="'#00a0d2'"/><xsl:variable name="relativeFontColor" select="'#ffffff'"/><title>XML Sitemap &#x2d; Janne Karttunen</title>
...
<link rel="icon" href="https://janne-karttunen.local/wp-content/uploads/2024/08/cropped-jk-logo-2-32x32.webp" sizes="32x32" />
<link rel="icon" href="https://janne-karttunen.local/wp-content/uploads/2024/08/cropped-jk-logo-2-192x192.webp" sizes="192x192" />
<link rel="apple-touch-icon" href="https://janne-karttunen.local/wp-content/uploads/2024/08/cropped-jk-logo-2-180x180.webp" />
<meta name="msapplication-TileImage" content="https://janne-karttunen.local/wp-content/uploads/2024/08/cropped-jk-logo-2-270x270.webp" />
			</head>
			<body class="ltr">
				<div id="description">
					<div class="wrap">
						<a href="https://janne-karttunen.local"><h1><img src="https://janne-karttunen.local/wp-content/uploads/2024/08/cropped-jk-logo-2-32x32.webp" width="29" height="29" />Janne Karttunen — XML Sitemap</h1></a>
<p>
